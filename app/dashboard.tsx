...
export default function DashboardScreen() {
  ...
  if (authLoading || profileLoading) return <Screen><Text style={Theme.text.h2}>Cargando...</Text></Screen>;
  if (!session) {
  ...
  return (
    <Screen>
      ...
      <AppCard title="Resumen profesional" subtitle="Este plan se ajusta a tus datos físicos, nivel, días disponibles y objetivo.">
        ...
        <Text style={{ ...Theme.text.body, marginTop: 8 }}>Esta app no reemplaza la valoración de un médico, nutricionista o profesional de salud.</Text>
      </AppCard>
    </Screen>
  );
}
